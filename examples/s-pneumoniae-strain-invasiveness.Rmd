...
trace_plot <- rstan::traceplot(full_adjusted_strain_and_serotype_specific_poisson_fit, pars = "lp__") + theme(axis.text.x = element_text(angle = 90))
...
write.csv(best_fitting_output %>%
            dplyr::select(combined,nu,nu_lower,nu_upper) %>%
