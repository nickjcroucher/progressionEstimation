...
best_fitting_output <- 
  progressionEstimation::process_progression_rate_model_output(full_adjusted_strain_and_serotype_specific_poisson_fit,
                                                               S_pneumoniae_infant_strain,
                                                               combined_strain_subtype = TRUE) %>%
    dplyr::mutate("categorisation" = S_pneumoniae_infant_strain$categorisation) %>%
...
sensitivity_S_pneumoniae_infant_strain %<>%
    dplyr::mutate(categorisation = factor(categorisation,
                                          levels = serotype_by_count[serotype_by_count %in% unique(sensitivity_S_pneumoniae_infant_strain$categorisation)])) %>%
  dplyr::mutate(strain = factor(strain))
